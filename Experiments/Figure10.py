...
for w in w_range:
    ...
    accuracies.append([TSNE.knn_accuracy(w, labeldict, k=5),
                        # TSNE.adjusted_rand_index(w, labeldict, k=5, res=0.1),
                        TSNE.adjusted_rand_index(w, labeldict, k=5, res=0.08)])#,
                        # TSNE.adjusted_rand_index(w, labeldict, k=10, res=0.08),
                        # TSNE.adjusted_rand_index(w, labeldict, k=10, res=0.05)])
